...
/**
 * Class to manage the required aspects of branch versioned editing
 * Editing features requires the starting and stopping of an edit session
 * using a GUID (sessionId)
 * https://developers.arcgis.com/rest/services-reference/enterprise/version-management-service.htm
 * 
 * Functions include:
 * - Accessing the VersionManagementServer service
 * - Getting/setting the target branch version
 * - Getting/setting the sessionId
 * - Starting/Stopping an edit session
 * - Purge locks
 * - Reserving ObjectIDs
 */
